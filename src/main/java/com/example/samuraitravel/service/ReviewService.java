...
public class ReviewService {
	...
	public Page<Review> findReviewsByHouseOrderByCreatedAtDesc(House house, Pageable pegeable) {
		return reviewRepository.findByHouseOrderByCreatedAtDesc(house, pegeable);
	}
